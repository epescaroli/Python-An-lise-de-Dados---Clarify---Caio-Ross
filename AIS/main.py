...
def correlacao():
    ...
    # regressão linear para vicualização
    ...
    fig.add_trace(go.Scatter(
        x = x,
        y = m * x + b,
        # façamos a inclinação multiplicada pelo valor do ponto de dado mais o intercepto gerando nossa linha de grafico
        mode = 'lines',
    ...
    graph_html = fig.to_html(full_html=False, includ_plotlyjs='cdn')
    return render_template_string('''
        <html>
            <head>
